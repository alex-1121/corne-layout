...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT(
     ...
     //|------+------+------+------+------+------|                |------+------+-------+------+-------+--------|
  LGUI_T(KC_ESC),KC_A,  KC_S,  KC_D,  KC_F,  KC_G,                   KC_H,  KC_J,  KC_K,  KC_L, KC_SCLN,LCTL_T(KC_QUOT),
     //|------+------+------+------+------+------|                |------+------+-------+------+-------+--------|
  ...
  //|------+------+-------+-------+-------+-------|                |------+------+------+------+------+------|
    _______, _______, _______, _______, _______, KC_BTN2,    _______,KC_HOME,  KC_END, _______,_______,_______,
  //|------+------+-------+-------+-------+-------+------|  |------+------+------+------+------+------+------|
                                   _______, LGUI(KC_BTN2),KC_BTN1,   _______, _______, _______
                                  //`--------------------'  `--------------------'
  ),
  ...
  [_ADJUST] = LAYOUT(
  //,-----------------------------------------.                ,-----------------------------------------.
     RESET, _______, _______, _______,RGB_TOG, _______,         _______,KC__MUTE,KC_VOLU,KC_MPLY,_______,_______,
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
    RGB_TOG,RGB_HUI,RGB_SAI,RGB_VAI,CG_TOGG,_______,            _______,KC_MPRV,KC_VOLD,KC_MNXT,_______,_______,
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
    RGB_MOD,RGB_HUD,RGB_SAD,RGB_VAD,RGB_SPD,_______,            _______,_______,  _______,  _______, _______, _______,
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
                                   _______, _______,_______,   _______, _______, _______
                              //`--------------------'  `--------------------'
  )
...
//      if (record->event.pressed) {
//        layer_on(_NUM);
//        update_tri_layer_RGB(_NUM, _MEDIA, _ADJUST);
//      } else {
//        layer_off(_NUM);
//        update_tri_layer_RGB(_NUM, _MEDIA, _ADJUST);
//      }
